...
namespace Taxi.Services.ServiceApp {
    ...
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(Taxi.Services.ServiceApp.LatLng))]
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(Taxi.Services.ServiceApp.VehicleOption))]
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(Taxi.Services.ServiceApp.AddressInfo))]
    ...
    [System.SerializableAttribute()]
    public partial class LatLng : Taxi.Services.ServiceApp.DataTypeBase {
    ...
    [System.SerializableAttribute()]
    public partial class VehicleOption : Taxi.Services.ServiceApp.DataTypeBase {
    ...
    [System.SerializableAttribute()]
    public partial class AddressInfo : Taxi.Services.ServiceApp.DataTypeBase {
        
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private string AddressField;
        
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private Taxi.Services.ServiceApp.LatLng LatLngField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public Taxi.Services.ServiceApp.LatLng LatLng {
            get {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Runtime.Serialization", "4.0.0.0")]
    [System.Runtime.Serialization.DataContractAttribute(Name="BookTripType", Namespace="http://schemas.datacontract.org/2004/07/Staxi.Business.DataTypes")]
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ServiceApp.IOperationService")]
    public interface IOperationService {
        ...
        bool SendOperatorCancel(System.Guid bookId, string msg, Taxi.Services.ServiceApp.SourceCancelType cancelType);
        ...
        bool SendInitTrip(
                    System.Guid bookId, 
                    Taxi.Services.ServiceApp.AddressInfo from, 
                    Taxi.Services.ServiceApp.AddressInfo to, 
                    string note, 
                    byte quantity, 
                    byte carType, 
                    byte customerType, 
                    string phone, 
                    Taxi.Services.ServiceApp.VehicleOption[] vehicleOptions, 
                    Taxi.Services.ServiceApp.LatLng currentLatLng, 
                    string[] lstVehiclesDeny, 
                    Taxi.Services.ServiceApp.BookTripType bookTripType, 
                    int money, 
                    float distance, 
                    Taxi.Services.ServiceApp.Direction direction, 
                    int moneyExtend, 
        ...
        bool RadioInitTrip(
                    ...
                    Taxi.Services.ServiceApp.ConfirmDoneBook state, 
                    Taxi.Services.ServiceApp.BookTripType bookTripType, 
                    int money, 
                    float distance, 
                    Taxi.Services.ServiceApp.Direction direction, 
        ...
        Taxi.Services.ServiceApp.OperatorCenterGPSData GetVehicleOnlne(string vehicle);
        ...
        Taxi.Services.ServiceApp.TcpOPVehicleResponse GetVehicle(string vehicle);
        ...
        bool SendConfirmDoneBook(System.Guid bookId, string vehiclePlate, Taxi.Services.ServiceApp.ConfirmDoneBook state);
        ...
        Taxi.Services.ServiceApp.OneTaxiCar[] FindCar(int carType, float lat, float lng);
        ...
        bool SendSMS_ReceiveCarInfo(System.Guid bookId, string mobile, string carNo, string vehiclePlate, string driverName, string driverPhone, Taxi.Services.ServiceApp.TcpOPBookTripType tripType, string carNoOld);
        ...
        bool SendSMS_ReceiveCatchedUser(System.Guid bookId, string mobile, string carNo, int money, Taxi.Services.ServiceApp.TcpOPBookTripType tripType, int giaPhuTroi, int quangduong, Taxi.Services.ServiceApp.TcpOPDirection dir, string param6, string param7, string param8, string param9, string param10);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IOperationService/SendSMS_ReceiveCatchedUser_V2", ReplyAction="http://tempuri.org/IOperationService/SendSMS_ReceiveCatchedUser_V2Response")]
        bool SendSMS_ReceiveCatchedUser_V2(System.Guid bookId, string mobile, string carNo, string driverName, string vehiclePlate, int money, Taxi.Services.ServiceApp.TcpOPBookTripType tripType, int giaPhuTroi, int quangduong, Taxi.Services.ServiceApp.TcpOPDirection dir, string param6, string param7, string param8, string param9, string param10);
        ...
        bool SendSMS_ReceiveDriverCancel(System.Guid bookId, string mobile, string carNo, Taxi.Services.ServiceApp.TcpOPBookTripType tripType);
        ...
        bool SendSMS_ReceiveNoCar(System.Guid bookId, string mobile, Taxi.Services.ServiceApp.TcpOPBookTripType tripType);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IOperationService/SendSMS_CustomerInfo", ReplyAction="http://tempuri.org/IOperationService/SendSMS_CustomerInfoResponse")]
        bool SendSMS_CustomerInfo(System.Guid bookId, string mobileDriver, string mobileCustomer, string info);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IOperationService/SendUpdateMoneyLongTrip", ReplyAction="http://tempuri.org/IOperationService/SendUpdateMoneyLongTripResponse")]
        bool SendUpdateMoneyLongTrip(System.Guid bookId, float distance, int money2, int moneyExtend, int moneyExtendByTime, string carNo, string vehiclePlate);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IOperationService/SendSMS_DuongThao_CustomerPhone", ReplyAction="http://tempuri.org/IOperationService/SendSMS_DuongThao_CustomerPhoneResponse")]
        bool SendSMS_DuongThao_CustomerPhone(string mobileDriver, string mobileCustomer, string info);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IOperationServiceChannel : Taxi.Services.ServiceApp.IOperationService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class OperationServiceClient : System.ServiceModel.ClientBase<Taxi.Services.ServiceApp.IOperationService>, Taxi.Services.ServiceApp.IOperationService {
        ...
        public bool SendOperatorCancel(System.Guid bookId, string msg, Taxi.Services.ServiceApp.SourceCancelType cancelType) {
        ...
        public Taxi.Services.ServiceApp.OperatorCenterGPSData GetVehicleOnlne(string vehicle) {
        ...
        public Taxi.Services.ServiceApp.TcpOPVehicleResponse GetVehicle(string vehicle) {
        ...
        public bool SendConfirmDoneBook(System.Guid bookId, string vehiclePlate, Taxi.Services.ServiceApp.ConfirmDoneBook state) {
        ...
        public Taxi.Services.ServiceApp.OneTaxiCar[] FindCar(int carType, float lat, float lng) {
            return base.Channel.FindCar(carType, lat, lng);
        }
        
        public bool SendSMS_ReceiveCarInfo(System.Guid bookId, string mobile, string carNo, string vehiclePlate, string driverName, string driverPhone, Taxi.Services.ServiceApp.TcpOPBookTripType tripType, string carNoOld) {
            return base.Channel.SendSMS_ReceiveCarInfo(bookId, mobile, carNo, vehiclePlate, driverName, driverPhone, tripType, carNoOld);
        }
        
        public bool SendSMS_ReceiveCatchedUser(System.Guid bookId, string mobile, string carNo, int money, Taxi.Services.ServiceApp.TcpOPBookTripType tripType, int giaPhuTroi, int quangduong, Taxi.Services.ServiceApp.TcpOPDirection dir, string param6, string param7, string param8, string param9, string param10) {
        ...
        public bool SendSMS_ReceiveDriverCancel(System.Guid bookId, string mobile, string carNo, Taxi.Services.ServiceApp.TcpOPBookTripType tripType) {
            return base.Channel.SendSMS_ReceiveDriverCancel(bookId, mobile, carNo, tripType);
        }
        
        public bool SendSMS_ReceiveNoCar(System.Guid bookId, string mobile, Taxi.Services.ServiceApp.TcpOPBookTripType tripType) {
            return base.Channel.SendSMS_ReceiveNoCar(bookId, mobile, tripType);
        }
        
        public bool SendSMS_CustomerInfo(System.Guid bookId, string mobileDriver, string mobileCustomer, string info) {
            return base.Channel.SendSMS_CustomerInfo(bookId, mobileDriver, mobileCustomer, info);
        }
        
        public bool SendUpdateMoneyLongTrip(System.Guid bookId, float distance, int money2, int moneyExtend, int moneyExtendByTime, string carNo, string vehiclePlate) {
            return base.Channel.SendUpdateMoneyLongTrip(bookId, distance, money2, moneyExtend, moneyExtendByTime, carNo, vehiclePlate);
        }
        ...
        public bool SendSMS_DuongThao_CustomerPhone(string mobileDriver, string mobileCustomer, string info) {
            return base.Channel.SendSMS_DuongThao_CustomerPhone(mobileDriver, mobileCustomer, info);
        }
    }
}
