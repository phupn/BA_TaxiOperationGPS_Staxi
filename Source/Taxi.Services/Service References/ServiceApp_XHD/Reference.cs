...
namespace Taxi.Services.ServiceApp_XHD {
    ...
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(Taxi.Services.ServiceApp_XHD.LatLng))]
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(Taxi.Services.ServiceApp_XHD.VehicleOption))]
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(Taxi.Services.ServiceApp_XHD.AddressInfo))]
    ...
    [System.SerializableAttribute()]
    public partial class LatLng : Taxi.Services.ServiceApp_XHD.DataTypeBase {
    ...
    [System.SerializableAttribute()]
    public partial class VehicleOption : Taxi.Services.ServiceApp_XHD.DataTypeBase {
    ...
    [System.SerializableAttribute()]
    public partial class AddressInfo : Taxi.Services.ServiceApp_XHD.DataTypeBase {
        
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private string AddressField;
        
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private Taxi.Services.ServiceApp_XHD.LatLng LatLngField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public Taxi.Services.ServiceApp_XHD.LatLng LatLng {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ServiceApp_XHD.IOperationService")]
    public interface IOperationService {
        ...
        bool SendOperatorCancel(System.Guid bookId, string msg, Taxi.Services.ServiceApp_XHD.SourceCancelType cancelType);
        ...
        bool SendInitTrip(
                    System.Guid bookId, 
                    Taxi.Services.ServiceApp_XHD.AddressInfo from, 
                    Taxi.Services.ServiceApp_XHD.AddressInfo to, 
                    string note, 
                    byte quantity, 
                    byte carType, 
                    byte customerType, 
                    string phone, 
                    Taxi.Services.ServiceApp_XHD.VehicleOption[] vehicleOptions, 
                    Taxi.Services.ServiceApp_XHD.LatLng currentLatLng, 
                    string[] lstVehiclesDeny, 
                    Taxi.Services.ServiceApp_XHD.BookTripType bookTripType, 
                    int money, 
                    float distance, 
                    Taxi.Services.ServiceApp_XHD.Direction direction, 
                    int moneyExtend, 
        ...
        bool RadioInitTrip(
                    ...
                    Taxi.Services.ServiceApp_XHD.ConfirmDoneBook state, 
                    Taxi.Services.ServiceApp_XHD.BookTripType bookTripType, 
                    int money, 
                    float distance, 
                    Taxi.Services.ServiceApp_XHD.Direction direction, 
        ...
        Taxi.Services.ServiceApp_XHD.OperatorCenterGPSData GetVehicleOnlne(string vehicle);
        ...
        Taxi.Services.ServiceApp_XHD.TcpOPVehicleResponse GetVehicle(string vehicle);
        ...
        bool SendConfirmDoneBook(System.Guid bookId, string vehiclePlate, Taxi.Services.ServiceApp_XHD.ConfirmDoneBook state);
        ...
        Taxi.Services.ServiceApp_XHD.OneTaxiCar[] FindCar(int carType, float lat, float lng);
        ...
        bool SendSMS_ReceiveCarInfo(System.Guid bookId, string mobile, string carNo, string vehiclePlate, string driverName, string driverPhone, Taxi.Services.ServiceApp_XHD.TcpOPBookTripType tripType, string carNoOld);
        ...
        bool SendSMS_ReceiveCatchedUser(System.Guid bookId, string mobile, string carNo, int money, Taxi.Services.ServiceApp_XHD.TcpOPBookTripType tripType, int giaPhuTroi, int quangduong, Taxi.Services.ServiceApp_XHD.TcpOPDirection dir, string param6, string param7, string param8, string param9, string param10);
        ...
        bool SendSMS_ReceiveDriverCancel(System.Guid bookId, string mobile, string carNo, Taxi.Services.ServiceApp_XHD.TcpOPBookTripType tripType);
        ...
        bool SendSMS_ReceiveNoCar(System.Guid bookId, string mobile, Taxi.Services.ServiceApp_XHD.TcpOPBookTripType tripType);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IOperationServiceChannel : Taxi.Services.ServiceApp_XHD.IOperationService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class OperationServiceClient : System.ServiceModel.ClientBase<Taxi.Services.ServiceApp_XHD.IOperationService>, Taxi.Services.ServiceApp_XHD.IOperationService {
        ...
        public bool SendOperatorCancel(System.Guid bookId, string msg, Taxi.Services.ServiceApp_XHD.SourceCancelType cancelType) {
        ...
        public Taxi.Services.ServiceApp_XHD.OperatorCenterGPSData GetVehicleOnlne(string vehicle) {
        ...
        public Taxi.Services.ServiceApp_XHD.TcpOPVehicleResponse GetVehicle(string vehicle) {
        ...
        public bool SendConfirmDoneBook(System.Guid bookId, string vehiclePlate, Taxi.Services.ServiceApp_XHD.ConfirmDoneBook state) {
        ...
        public Taxi.Services.ServiceApp_XHD.OneTaxiCar[] FindCar(int carType, float lat, float lng) {
        ...
        public bool SendSMS_ReceiveCatchedUser(System.Guid bookId, string mobile, string carNo, int money, Taxi.Services.ServiceApp_XHD.TcpOPBookTripType tripType, int giaPhuTroi, int quangduong, Taxi.Services.ServiceApp_XHD.TcpOPDirection dir, string param6, string param7, string param8, string param9, string param10) {
