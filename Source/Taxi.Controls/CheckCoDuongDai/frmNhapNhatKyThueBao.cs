...
namespace Taxi.Controls.FormCheckCoDuongDai
{
    public partial class frmNhapNhatKyThueBao : Form
    {
        ...
        private void frmNhapNhatKyThueBao_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (g_IsAddNew)
                {
                    ...
                    calDon.EditValue = new DateTime(g_dateThoiGianNhap.Year, g_dateThoiGianNhap.Month, g_dateThoiGianNhap.Day, g_dateThoiGianNhap.Hour, g_dateThoiGianNhap.Minute, 0);
                    calTra.EditValue = new DateTime(g_dateThoiGianNhap.Year, g_dateThoiGianNhap.Month, g_dateThoiGianNhap.Day, 0, 0, 0);
                ...
                else
                {
                    ...
                    if (objThueBao.KieuTuyenDuong == 1)
                    {
                        radNgoaiThanh.Checked = true;
                    }
                    else if (objThueBao.KieuTuyenDuong == 2)
                    {
                        radNgoaiTinh.Checked = true;
                    }
                    else
                    {
                    ...
                    if (!g_DaCoKmTra)
                    {
                        ...
                        if (objThueBao.LoaiXeID > 0)
                            cboLoaiXe.EditValue = objThueBao.LoaiXeID;
                        ...
                        calDon.EditValue = objThueBao.ThoiGianDon;
                        ...
                        calTra.EditValue = new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day, 0, 0, 0);
                    ...
                    else  //Da co du lieu km tra
                    {
                        ...
                        //Set mac dinh thoi gian cho
                        calTra.EditValue = objThueBao.ThoiGianTra;
            ...
            {
                LogError.WriteLogError("frmNhapNhatKyThueBao_Load: ", ex);                
            }
        }
        ...
        private int ValidateForm(bool NoKmTra, bool IsTinhToan)
        {
            ...
            if (SoHieuXe.Length < 2) return 1;
            if (cboLoaiXe.EditValue.To<int>() < 0) return 2;
            if (radKhac.Checked)
            {
            ...
            if (NoKmTra)
            {
                ...
                if (chkCoDonTraKhach.Checked)
                {
                    ...
                    if (calTra.DateTime.CompareTo(calDon.DateTime) <= 0) return 6;
                }
        ...
        private void chkCoDonTraKhach_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (calTra.DateTime.Hour == 0 && calTra.DateTime.Minute == 0)
            {
                calTra.EditValue = new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day, DateTime.Now.Hour, DateTime.Now.Minute, 0);
            }
        ...
        {
            LoaiXe LoaiXecontrol = new LoaiXe();
            DataTable dt = LoaiXecontrol.GetAll();
            cboLoaiXe.Properties.DataSource = dt;
            cboLoaiXe.Properties.DisplayMember = "TenLoaiXe";
            cboLoaiXe.Properties.ValueMember = "LoaiXeID";
        }
        ...
        private void txtSoHieuXe_TextChanged(object sender, EventArgs e)
        {
            ...
            if (SoHieuXe.Length >= 3)
            {
                ...
                {
                    new MessageBox.MessageBoxBA().Show("Xe không tồn tại (không có trong danh sách xe). Bạn yêu cầu quản trị nhập số hiệu xe.");
                    txtSoHieuXe.Focus();
                    return;
                }
                Xe objXe = new Xe();
                objXe = objXe.GetChiTietXe(SoHieuXe);
                if (objXe != null && objXe.LoaiXeID > 0)
                    cboLoaiXe.EditValue = objXe.LoaiXeID;
                btnLuu.Enabled = true;
            }
        }
        ...
        private void btnTinhToan_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                TimeSpan timeThoiGianChuyenDi = calTra.DateTime - calDon.DateTime;
                string TextTroi = "";
                ...
                {
                    new MessageBox.MessageBoxBA().Show("Không xác định được giờ thông tin giá vượt quy định. Liên hệ với quản trị nhập vượt giờ quy định.");
                    return;
                }

                double GiaTienQuyDinh = 0;
                double ThoiGianQuyDinh = 0;
                double KMQuyDinh = 0;
                string GiaThueBao = txtGiaThueBao.Text.Trim();
                string[] arrGiaThueBao = null;
                if (string.IsNullOrEmpty(GiaThueBao))
                {
                    new MessageBox.MessageBoxBA().Show("Chưa có thông tin giá thuê bao"); return;
                }

                arrGiaThueBao = GiaThueBao.Split('/');
                if (arrGiaThueBao.Length != 3)
                {
                    new MessageBox.MessageBoxBA().Show("Giá thuê bao không hợp lệ"); return;
                }
                if (!double.TryParse(arrGiaThueBao[0], out GiaTienQuyDinh))
                {
                    new MessageBox.MessageBoxBA().Show("Giá tiền thuê bao không hợp lệ"); return;
                }
                if (!double.TryParse(arrGiaThueBao[2], out ThoiGianQuyDinh))
                {
                    new MessageBox.MessageBoxBA().Show("Thời gian thuê bao không hợp lệ"); return;
                }
                if (!double.TryParse(arrGiaThueBao[1], out KMQuyDinh))
                {
                    new MessageBox.MessageBoxBA().Show("KM thuê bao không hợp lệ"); return;
                }
                long KMKhachDi = 0;
                if(!string.IsNullOrEmpty(txtKmThucDi.Text))
                     KMKhachDi = Convert.ToUInt32(txtKmThucDi.Text);
                // Xử lý đi tuyến một chiều
                if (radMotChieu.Checked == true)
                {
                    int PhanGio = 0;
                    int PhanPhut = 0;
                    string strSoThucThoiGian = ThoiGianQuyDinh.ToString();
                    if (strSoThucThoiGian.Contains("."))
                    {
                        PhanGio = Convert.ToInt32(Math.Truncate(ThoiGianQuyDinh));
                        PhanPhut = 30;
                    }
                    else
                    {
                        PhanGio = Convert.ToInt32(ThoiGianQuyDinh);
                        PhanPhut = 0;
                    }
                    ...
                    // Km troi
                    double KmtroiT = KMKhachDi - KMQuyDinh;
                    //KHUYEN MAI
                    ...
                    else
                    {
                        if (timeTroi.Hours >= 0 || timeTroi.Minutes > 0) // Kiểm tra có trội
                        {
                            if (timeTroi.Hours >= 0)
                            {
                                TextTroi = string.Format("{0}h", timeTroi.Hours);
                            }
                            if (timeTroi.Minutes > 0)
                            {
                                TextTroi += string.Format(" {0}'", timeTroi.Minutes);
                            }
                            ...
                            if (phut > 0)
                            {
                                Tientroi += 1 * VuotGioQuyDinhControl.GiaTienVuot1Gio * (phut / 60.0);
                            }
                        }
                        // TInh tiền km trội  
                        if (KmtroiT >= 1)
                        ...
                        Tientroi = Math.Round(Tientroi, 1);
                        TienTra = GiaTienQuyDinh + Tientroi;
                    }
                }
                else  // HAI CHIEU
                {
            ...
            catch (Exception ex)
            {
                ...
                btnTinhToan.Enabled = true; btnLuu.Enabled = true;
                LogError.WriteLogError("btnTinhToan_Click: ", ex);
            }
        }
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (g_IsAddNew)
                {
                    ...
                    {
                        objThueBao.ThoiGianTra = calTra.DateTime;
                    ...
                    if (so <= 0)
                    {
                        new MessageBox.MessageBoxBA().Show("Nhập mới bị lỗi.");
                    }
                }
                #endregion THEM MỚI
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            new MessageBox.MessageBoxBA().Show("Có lỗi nhập dữ liệu. Bạn cần kiểm tra lại");
                        }
                    }
                    ...
                    if (so <= 0)
                    {
                        ...
                        new MessageBox.MessageBoxBA().Show("Cập nhật không thành công.Bạn cần kiểm tra lại dữ liệu nhập.");
                    }
        ...
        private void cboLoaiXe_SelectedValueChanged(object sender, EventArgs e)
        {
            try
            {
                if (cboLoaiXe.EditValue != null)
                {
                    g_LoaixeID = int.Parse(cboLoaiXe.EditValue.ToString());
                    if ((g_LoaixeID > 0) & g_TuyenDuongID.Length > 0)
                    {
                        this.LoadGiacuoc(g_IsQuanToan, g_LoaixeID, g_TuyenDuongID);
                    }
            ...
            {
                LogError.WriteLogError("cboLoaiXe_SelectedValueChanged: ", ex);                
            }
        }
        ...
        private void calDon_ValueChanged(object sender, EventArgs e)
        {
            ...
            btnTinhToan.Enabled = true; btnLuu.Enabled = true;
            btnTinhToan.Enabled = true; btnLuu.Enabled = true;
            TimeSpan tp = calTra.DateTime - calDon.DateTime;
