...
{
    public partial class frmGiamSatXe_ChuyenVung_XinDiemDo : FormBase
    {
        #region ==== Define ====
        ...
        #region ==== INI ====
        public frmGiamSatXe_ChuyenVung_XinDiemDo()
        {
            InitializeComponent();
        ...
        private bool IsValid()
        {
            ...
            //if (lblViTri.Text.Trim() == "")
            //{
            //    lblmsg.Text = ("Bạn chưa nhập vị trí");
            //    lblViTri.Focus();
            //    return false;
            //}
        ...
        private void ThemXeXinDiemDo()
        {
            if (IsValid())
            {
                lienlac.GSX_BaoChuyenVung_XuLy(txtSoHieu.GetColumnValue("SoHieuXe").ToString(),
                                               ...
                                               lVungDieuHanh.GetColumnValue("NameVungDH").ToString(),
                                                ...
                                                "Điểm đỗ cũ " + lblViTri.Text,
                                                "Xe xin đỗ tại " + lVungDieuHanh.GetColumnValue("NameVungDH").ToString(),
        ...
        private void frmGiamSatXe_ChuyenVung_XinDiemDo_Load(object sender, EventArgs e)
        {
            ...
            txtSoHieu.Properties.DataSource = lienlac.GetListAllXe_ForXinDiemDo();
