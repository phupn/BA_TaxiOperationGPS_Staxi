...
namespace Taxi.Controls.POI
{
    public partial class frmPOI : Form
    {
        ...
        double _vido, _kinhdo;
        public frmPOI(string TenPOI, string viettat, string diachi, double vido, double kinhdo)
        {
            InitializeComponent();
            txtPOIName.Text = TenPOI;
            txtAddress.Text = diachi;
            txtVietTat.Text = viettat;
            txtViDo.Text = vido.ToString();
            txtKinhDo.Text = kinhdo.ToString();
            _vido = vido;
            _kinhdo = kinhdo;
        ...
        private void frmPOI_Load(object sender, EventArgs e)
        {
            ...
            {                
                ...
                {
                    MainMap.addMarkerCustomer(new PointLatLng(_vido, _kinhdo), "");
                    _currentMarker = MainMap.MarkerCustomer;
                    MainMap.Position = _currentMarker.Position;
                }
            }
            catch (Exception ex)
            {
        ...
        private void txtPOIName_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void txtKinhDo_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyData == Keys.Enter)
            {
                txtViDo.Focus();
        ...
        private void txtViDo_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyData == Keys.Enter)
            {
                btnSave.Focus();
