...
{
    /// <summary>
    /// Panel chứa các IShInput
    /// </summary>
    public class ShPanel : PanelControl
    {
        private ShLabel labelMessage;
        /// <summary>
        /// Label để hiển thị message
        /// </summary>
        public ShLabel LabelMessage
        {
        ...
        public Dictionary<string, object> GetValuesInput()
        {
            ...
            // Lấy những Control mà là IShInput, Tag khác rỗng
        ...
        private List<IShInput> listInputs = null;
        /// <summary>
        /// Danh sách các Inputs có trên Form
        /// </summary>
        public List<IShInput> ListInputs
        {
            get
            {
        ...
        public void SetEnabled(bool enabled, bool clearWhenEnabled, params string[] tagName)
        {
            if (tagName!=null&&tagName.Count()>0)
            {
                ...
                ListInputs.Cast<Control>().Join(tagName, c => c.Tag.ToString(), t => t, (c, t) =>
                {
                    ...
                    if (clearWhenEnabled) (c as IShInput).Clear();
