...
namespace Taxi.Controls.Base.Extender
{
    ...
    public static class GridViewExtender
    {
        ...
        /// </summary>
        public static T Add<T>(this GridView gv, params string[] columnName) where T : RepositoryItem, IShControl, new()
        {
        ...
        /// <param name="gv"></param>
        /// <param name="columnName"></param>
        public static T Add<T>(this GridView gv, Action<T> action, params string[] columnName) where T : RepositoryItem, IShControl, new()
        {
            // Khởi tạo IRepository
            T t = new T();
        ...
        public static T Add<T, TModel>(this GridView gv, Func<List<TModel>> func, params string[] columnName)
            where T : RepositoryItem, IShControl, IRepository<TModel>, new()
