...
namespace Taxi.Controls.Base.Inputs
{
    ...
    /// </summary>
    public class PlaceholderTextBox : TextBox, IShInput, IShKeyPress, ITextChange
    {
        public bool IsChangeText { get; set; }
        public bool IsForceChangeText { get; protected set; }
        public bool IsFocus { get; set; }
        private string _text_old { get; set; }
        ...
        {
            if (IsForceChangeText&&this.Text==_text_old)
            {
                IsForceChangeText = false;
            }
            IsFocus = false;
            ...
            get
            {
                ...
                if (this.IsPlaceholderActive &&
                    Environment.StackTrace.Contains(
                        "System.Windows.Forms.Control.InitializeDCForWmCtlColor(IntPtr dc, Int32 msg)"))
        ...
        {
            //if (EnterMoveNextControl && (e.KeyData == Keys.Enter))
            //{
            //    SendKeys.Send("{TAB}");
            //    return;
            //}
            ...
            if (IsPlaceholderActive &&
                ...
                e.Handled = true;
            if ((e.KeyData == Keys.Delete||e.KeyData==Keys.End)&&string.IsNullOrEmpty(Text)) {
                e.Handled = true;
            }
            base.OnKeyDown(e);
        }
