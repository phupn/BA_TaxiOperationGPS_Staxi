...
namespace TaxiOperation_CSKH.Reports {
    ...
    public class Baocao_Bieumau2 : ReportClass {
        
        public Baocao_Bieumau2() {
        }
        
        public override string ResourceName {
            get {
                return "Baocao_Bieumau2.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "TaxiOperation_CSKH.Reports.Baocao_Bieumau2.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedBaocao_Bieumau2 : Component, ICachedReport {
        
        public CachedBaocao_Bieumau2() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            Baocao_Bieumau2 rpt = new Baocao_Bieumau2();
            rpt.Site = this.Site;
            return rpt;
        }
