...
{
    public class DMTinhThanh : DBObject
    {
        public DMTinhThanh()
        {
       ...
       public System.Data.DataTable GetTinhThanhByID(int ID)
       {
       ...
       public System.Data.DataTable GetAllTinhThanh()
       {
            SqlParameter[] parameters = new SqlParameter[] {};
            return this.RunProcedure("sp_T_DMTinhThanh_SelectAll", parameters, "tblGara").Tables[0];
       }

       public System.Data.DataTable GetQuanHuyenByID(int ID)
       {
           SqlParameter[] parameters = new SqlParameter[] { new SqlParameter("@MaTinhThanh", SqlDbType.Int) };
           parameters[0].Value = ID;

           return this.RunProcedure("SP_GIS_T_DISTRICT_GETBYID", parameters, "tblGara").Tables[0];
       }
