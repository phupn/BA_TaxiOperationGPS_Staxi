...
namespace Taxi.GUI
{
    public partial class frmDieuHanhBoDamNEW_V3 : Form
    {
        ...
        private const string LENH_8_RADAUNGO = "Đón xe";
        ...
        private const string LENH_SANBAY = "SÂN BAY";
        ...
        private const string LENH_Hoan = "Hủy";
        private const string LENH_Truot = "Rớt điểm";
            ...
            try
            {
                ...
                if (DieuHanhTaxi.CheckConnection())
                {
                    ...
                    if (g_strVungsDuocCapPhep.Length > 0)
                    {
                        ...
                        G_arrProvince = Taxi.Business.CheckCoDuongDai.Province.GetAllProvince();
                        G_arrDistrict = Taxi.Business.CheckCoDuongDai.District.GetAllDistrict();
                        G_arrCommune = Taxi.Business.CheckCoDuongDai.Commune.GetAllCommune();
                        LoadListLaiXe();
                        ...
                        if (license.idxCompany == 18)
                        {
                            LENH_9_TIEPTHIXEKHAC = "Đã Gặp Khách";
                            lblPhim9.Text = "9:" + LENH_9_TIEPTHIXEKHAC;
                        }
                        #endregion
        ...
        private void HienThiAnhTrangThai_MauChu(GridEXRow row)
        {
            try
            {
                ...
                else if (cuocGoi.LenhDienThoai == LENH_KHACHDAT||cuocGoi.LenhDienThoai==LENH_SANBAY)
                {
                    GridEXFormatStyle RowStyle = new GridEXFormatStyle();
        ...
        private void LoadCuocGoiMoiTongDai_DaNhan(ref List<CuocGoi> listCuocGoiHienTai, string vungsDuocCapPhep, DateTime thoiDiemLayDuLieuTruoc, ref bool hasCapNhat, ref bool hasThemMoi,ref DateTime DateMax)
        {
            ...
            List<CuocGoi> listCuocGoiMoi;
            if(ThongTinCauHinh.FT_Active)
                listCuocGoiMoi = CuocGoi.G5_TONGDAI_LayCuocGoiDaNhanXuLy(vungsDuocCapPhep, thoiDiemLayDuLieuTruoc);
            else 
                listCuocGoiMoi = CuocGoi.G5_TONGDAI_LayCuocGoiDaNhanXuLyNotFT(vungsDuocCapPhep, thoiDiemLayDuLieuTruoc);
            if (listCuocGoiMoi != null && listCuocGoiMoi.Count > 0)
            {
                hasCapNhat = true;
                for (int i = 0; i < listCuocGoiMoi.Count; i++)
        ...
        private void uiTabCuocGoiDangThucHien_SelectedTabChanged(object sender, Janus.Windows.UI.Tab.TabEventArgs e)
        {
            ...
            else if (e.Page.Name == "uiTabPage_KNPA")
            {
                g_TabKetThucDuocChon = false;
                g_boolChuyenTabCuocGoiSearch = false;
                ctrlDSKhieuNai.LoadPhanAnh_ChuaGiaiQuyet(0);
            }
            else if (e.Page.Name == "tabCuocGoiKenh")
            {
                txtDiaChi.Focus();
        ...
        private void uiCommandBar2_CommandClick(object sender, Janus.Windows.UI.CommandBars.CommandEventArgs e)
        {
            ...
            else if (e.Command.Key == "cmdBanDoOnline")
            {
                new Taxi.Controls.Maps.FrmBanDo_Online().Show();
            }
        }
        ...
        private bool NhapXeNhan(CuocGoi cuocGoiRow, int positionRowSelect, string value)
        {
            ...
            {
                new Taxi.MessageBox.MessageBoxBA().Show(this, string.Format("[Lệnh {0}] " + "Cuội gọi lại, không nhập {1}.", LENH_Truot, XENHAN), "Thông báo", Taxi.MessageBox.MessageBoxButtonsBA.OK, Taxi.MessageBox.MessageBoxIconBA.Error);
            }
            return false;
        }
        ...
        {            
            ...
            if (gridCuocGois.RowCount > 0)
            {
                ...
                else if ((e.KeyCode == Keys.D1 || e.KeyCode == Keys.NumPad1))
                {
                    ...
                    {
                        msgDialog.Show(this, String.Format("[Lệnh {0}] Cuội gọi phải là cuộc gọi taxi. Và đã có {1}", LENH_1_MOIKHACH, XENHAN), "Thông báo", Taxi.MessageBox.MessageBoxButtonsBA.OK, Taxi.MessageBox.MessageBoxIconBA.Error);
                    }                    
                }
                #endregion
                ...
                //        {
                //            msgDialog.Show(this, String.Format("[Lệnh {0}] Cuội gọi đã có {1} hoặc {2}.", LENH_3_KHONGXE, XENHAN, XEDON),
                ...
                //    else
                //    {
                //        msgDialog.Show(this, String.Format("[Lệnh {0}] Cuội gọi phải là cuộc gọi taxi.", LENH_2_KHONGXE_XINLOI1), "Thông báo", Taxi.MessageBox.MessageBoxButtons.OK, Taxi.MessageBox.MessageBoxIcon.Error);
                //    }
                ...
                else if (e.KeyCode == Keys.D3 || e.KeyCode == Keys.NumPad3)
                {
                    if (cuocGoiRow.KieuCuocGoi == KieuCuocGoi.GoiTaxi)
                    {
                        ...
                        {
                            msgDialog.Show(this, String.Format("[Lệnh {0}] Cuội gọi đã có {1}.", LENH_3_KHONGXE, XENHAN),
                ...
                else if (e.KeyCode == Keys.D7 || e.KeyCode == Keys.NumPad7)
                {
                    ...
                    {
                        msgDialog.Show(this, String.Format("[Lệnh {0}] Cuội gọi phải là cuộc gọi taxi. Và đã có {1}", LENH_7_MOIKHACHLAN2, XENHAN), "Thông báo", Taxi.MessageBox.MessageBoxButtonsBA.OK, Taxi.MessageBox.MessageBoxIconBA.Error);
                    }
                    ...
                    //    //CuocGoi.G5_History_Create((int)cuocGoiRow.IDCuocGoi, content, (int)Enum_FastTaxi_Status.MoiKhach, true, flg);
                    //}
                    #endregion
                }
                #endregion

                #region ============== 8 : Ra đầu ngõ - Đón xe
                else if (e.KeyCode == Keys.D8 || e.KeyCode == Keys.NumPad8)
                {
                    ...
                    {
                        msgDialog.Show(this, String.Format("[Lệnh {0}] Cuội gọi phải là cuộc gọi taxi. Và đã có {1}", LENH_8_RADAUNGO, XENHAN), "Thông báo", Taxi.MessageBox.MessageBoxButtonsBA.OK, Taxi.MessageBox.MessageBoxIconBA.Error);
                    }
                }
                #endregion

                #region ============== 2 : Tiếp thị 7C/4C
                else if (e.KeyCode == Keys.D2 || e.KeyCode == Keys.NumPad2)
                {
                    if (cuocGoiRow.KieuCuocGoi == KieuCuocGoi.GoiTaxi)
                    {
                ...
                //    else
                //    {
                //        msgDialog.Show(this, String.Format("[Lệnh {0}] Cuội gọi phải là cuộc gọi taxi. Và đã có {1}", LENH_GAPCHUA, XENHAN), "Thông báo", Taxi.MessageBox.MessageBoxButtons.OK, Taxi.MessageBox.MessageBoxIcon.Error);
                //    }
                //}
                #endregion
                ...
                else if (e.KeyCode == Keys.T)
                {
                    ...
                    {
                        string dialog = msgDialog.Show(string.Format("{1} cuốc {0}...?", cuocGoiRow.DiaChiDonKhach, LENH_Truot), "Thông báo", Taxi.MessageBox.MessageBoxButtonsBA.YesNo, Taxi.MessageBox.MessageBoxIconBA.Question);
                        if (dialog == "Yes")
                        {
                            hasThucHienLenh = true;
                    ...
                    {
                        msgDialog.Show(this, string.Format("[Lệnh {0}] " + "Cuội gọi phải là cuộc gọi taxi và có {1}.",LENH_Truot, XENHAN), "Thông báo", Taxi.MessageBox.MessageBoxButtonsBA.OK, Taxi.MessageBox.MessageBoxIconBA.Error);
                    }
                ...
                else if (e.KeyCode == Keys.H)
                {
                    if (cuocGoiRow.KieuCuocGoi == KieuCuocGoi.GoiTaxi)// && cuocGoiRow.XeNhan=="") - cho hoãn mọi lúc mọi nơi.
                    {
                        ...
                        if (cuocGoiRow.XeNhan != null && cuocGoiRow.XeNhan != "")
                        {
                            ...
                            {
                                msgDialog.Show(this, string.Format("[Lệnh {0}] " + "Cuội gọi phải là cuộc gọi taxi và chưa có {1}.", LENH_Hoan, XENHAN), "Thông báo", Taxi.MessageBox.MessageBoxButtonsBA.OK, Taxi.MessageBox.MessageBoxIconBA.Error);
                                return;
                            }
                        }
                        dialog = msgDialog.Show(string.Format("{1} cuốc {0}...?", cuocGoiRow.DiaChiDonKhach, LENH_Hoan), "Thông báo", Taxi.MessageBox.MessageBoxButtonsBA.YesNo, Taxi.MessageBox.MessageBoxIconBA.Question);
                        if (dialog == "Yes")
                        {
                            hasThucHienLenh = true;
                    ...
                    {
                        msgDialog.Show(this, string.Format("[Lệnh {0}] " + "Cuội gọi phải là cuộc gọi taxi",LENH_Hoan), "Thông báo", Taxi.MessageBox.MessageBoxButtonsBA.OK, Taxi.MessageBox.MessageBoxIconBA.Error);
                    }                    
                }
                #endregion
                ...
                else if (e.KeyCode == Keys.G)
                {
                    ...
                    {
                        msgDialog.Show(this, "Bạn không có quyền gửi tin nhắn.", "Thông báo", Taxi.MessageBox.MessageBoxButtonsBA.OK, Taxi.MessageBox.MessageBoxIconBA.Warning);
                    }
        ...
        private void NhapDuLieuVaoTruyenDi(CuocGoi cuocGoi)
        {
            ...
            if (uiTabCuocGoiDangThucHien.SelectedIndex == 0)
            {
                ...
                if (ketQua == DialogResult.OK)
                {
                    ...
                    if (!CuocGoi.G5_TONGDAI_UpdateThongTinCuocGoi(cuocGoi))
                    {
                        MessageBox.MessageBoxBA msgDialog = new Taxi.MessageBox.MessageBoxBA();
            ...
            if (listCuocGoiHienTai != null && listCuocGoiHienTai.Count > 0)
            {
                ...
                if (index >= 0)
                {
                    if (isDuLieuCuaTongDai)
                    {
                        ...
                        cuocGoiCurrent.ThoiGianDonKhach = cuocGoi.ThoiGianDonKhach; listCuocGoiHienTai[index].MOIKHACH_LenhMoiKhach = cuocGoi.MOIKHACH_LenhMoiKhach;
