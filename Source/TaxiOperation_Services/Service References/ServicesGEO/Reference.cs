...
namespace TaxiOperation_Services.ServicesGEO {
    ...
    public interface IServicesOnline {
        ...
        string GetAddressByGeo(TaxiOperation_Services.ServicesGEO.AuthenticationHeader authenticate, float lng, float lat);
        ...
        string GetGeobyAddressBA(TaxiOperation_Services.ServicesGEO.AuthenticationHeader authenticate, string address, string TenTinh);
        ...
        string GetGeobyAddressBA_HN_First(TaxiOperation_Services.ServicesGEO.AuthenticationHeader authenticate, string address, string TenTinh);
        ...
        string GetAddressByGeo_Google(TaxiOperation_Services.ServicesGEO.AuthenticationHeader authenticate, float lng, float lat);
        ...
        string GetGeoByAddress_Google(TaxiOperation_Services.ServicesGEO.AuthenticationHeader authenticate, string address, string TenTinh);
        ...
        string GetGeoByAddress_GoogleV2(TaxiOperation_Services.ServicesGEO.AuthenticationHeader authenticate, string address);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServicesOnlineChannel : TaxiOperation_Services.ServicesGEO.IServicesOnline, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServicesOnlineClient : System.ServiceModel.ClientBase<TaxiOperation_Services.ServicesGEO.IServicesOnline>, TaxiOperation_Services.ServicesGEO.IServicesOnline {
        ...
        public string GetAddressByGeo(TaxiOperation_Services.ServicesGEO.AuthenticationHeader authenticate, float lng, float lat) {
            return base.Channel.GetAddressByGeo(authenticate, lng, lat);
        }
        
        public string GetGeobyAddressBA(TaxiOperation_Services.ServicesGEO.AuthenticationHeader authenticate, string address, string TenTinh) {
        ...
        public string GetGeoByAddress_Google(TaxiOperation_Services.ServicesGEO.AuthenticationHeader authenticate, string address, string TenTinh) {
