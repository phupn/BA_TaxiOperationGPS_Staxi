...
namespace OneTaxi.Controls.Base.Inputs
{
    ...
    /// Input chọn nhiều
    /// </summary>
    public class InputCheckedComboBox : CheckedComboBoxEdit, IInput, IKeyPress, ITextChange
    {
    ...
    public class InputCheckedComboBox<T> : InputCheckedComboBox, IInput, IBindControl where T : ModelBase, new()
    {
        /// <summary>
