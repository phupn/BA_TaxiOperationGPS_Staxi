...
namespace Taxi.GUI
{
    public partial class frmBodamInputData_V3: Form
    {
        ...
        public frmBodamInputData_V3(DateTime timeServer, CuocGoi cuocGoi, List<string> listSoHieuXe, bool isCuocGoiKetThuc, int soLuongCS, bool IsThoatCuoc999)
        {
            ...
            {
                lblXeNhan.Text = "Xe đă(n)g ký";
                //lblXeDenDiem_Help.Text = "Xe nhận";
                lblXeDon.Text = "(X)e nhận đón khách";
                chkHoan.Text = "Hủy/H(o)ãn";
                lblVungChuyen.Text = "(V)ùng/Net";
            }
        }
        ...
        private bool KiemTraXeNhan(string xeNhan)
        {
            ...
            G_XeNhanLength = arrXeNhan.Length;
            for (int i = 0; i < G_XeNhanLength; i++)
            {
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            if (maValidate == BangMaValidate.ValidateSuccess)
            {
                ...
                #region XeDon
                if (!string.IsNullOrEmpty(xeDon) && xeDon != g_cuocGoi.XeDon)
                {
                    string[] arrXedon = xeDon.Split('.');
                    int xeDonLength = arrXedon.Length;
                    ...
                    {
                        if (xeDonLength < g_cuocGoi.SoLuong)
                        {
                        ...
                        else if (xeDonLength > g_cuocGoi.SoLuong)//*hot
                        {
        ...
        protected override bool ProcessDialogKey(Keys keyData)
        {
            ...
            {
                chkKetThucHoiDam.Checked = !chkKetThucHoiDam.Checked;
                return true;
            }
        ...
        private bool updateDSXeNhan_ToaDo()
        {
            try
            {
                ...
                {
                    if (string.IsNullOrEmpty(g_cuocGoi.XeNhan_TD))
                    {
        ...
        private void chkTaxiGroupDon_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                maskXeDon.Text = maskXeDon.Text.Replace(XeDaDon, "");
                maskXeNhan.Text = maskXeNhan.Text.Replace(XeDaDon, "");
            }
        }
