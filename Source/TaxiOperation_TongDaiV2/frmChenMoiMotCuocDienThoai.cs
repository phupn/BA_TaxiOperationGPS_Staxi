...
namespace TaxiOperation_TongDai
{
    public partial class frmChenMoiMotCuocDienThoai : Form
    {
        ...
        public frmChenMoiMotCuocDienThoai()
        {
            InitializeComponent();
        }
        ...
        #region Events!
        private void frmChenMoiMotCuocDienThoai_Load(object sender, EventArgs e)
        {
            KhoiTao();
        ...
        {
            {
                ...
                {
                    bInsertOK = objDHTaxi.InsertCuocGoiLanDau_TongDai();
                    iLan++;
                    if (!bInsertOK)
                        Thread.Sleep(50);
                }
